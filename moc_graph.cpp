...
QT_MOC_LITERAL(3, 17, 14)
    ...
    "Graph\0updateGUI\0\0QVector<float>"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateGUI((*reinterpret_cast< QVector<float>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Graph::*_t)(QVector<float> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::updateGUI)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Graph::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Graph.data,
...
// SIGNAL 0
void Graph::updateGUI(QVector<float> _t1)
{
